#include <stdio.h>
  #include <string.h>
    ...
    Result1 = população1 > população2; 
    Result2 = areakm1 > areakm2;    
    Result3 = pib1 > pib2;           
    Result4 = pontosturisticos1 > pontosturisticos2; 
    Result5 = densidadepopulacional1 < densidadepopulacional2; 
    Result6 = pibpercapita1 > pibpercapita2; 
    Result7 = Superpoder1 > Superpoder2;
